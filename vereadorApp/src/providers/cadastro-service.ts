...
export class CadastroService {
  ...
  public cadastrar(novoUser : Usuario):Promise <any>{
    return this.http.post(this.link, JSON.stringify({usuario:novoUser}), { headers: this.headers }).toPromise().then(res=>res.json())
